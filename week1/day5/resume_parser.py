...
If information for a field is missing, return an empty list.
...
def final_score(job,resume):
    ...
    Keep the response concise ans easy to read.
"""
    message={
        "role" : "user",
        "content" : prompt
...
def parse_resume(resume_text):
    ...
    Skills may also appear in the skills section, work expereience, internships or projects.
...
for file_path in resume_folder.iterdir():
    ...
    #score and details
    #account chtgpt
    #request limit to prevent overloading the API
    time.sleep(5)
